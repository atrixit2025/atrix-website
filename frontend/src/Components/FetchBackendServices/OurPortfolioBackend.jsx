...
import "./OurPortfolioBackend.css"
import Button from '../Button';


const OurPortfolioBackend = () => {
    const Protfolio = [
        {
            img: project1,
            title: "Cartoon Bank",
                                ...
                                <div className='border border-(--black)  rounded-2xl'>
                                    <div className="bg-(--black) pt-8 px-8   rounded-t-lg ">
                                        ...
                                        <div className='relative'>
                                            <img src={item.img} alt={item.title} className="w-full  object-cover mt-5" />
...
export default OurPortfolioBackend;
