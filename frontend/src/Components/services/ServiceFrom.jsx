...
const ServiceFrom = () => {
    return (
        <section className="service-from-sec my-20">
            <div className="container mx-auto">
                <form className="form-wrapper  grid grid-cols-12 space-x-24 ">
                    <div className="form-sec col-span-8 space-y-10 ">

                        <div className='flex items-end' >
                            <p className="text-white text-lg py-2 self-end   min-w-1/3">Hi! My name is</p>
                        ...
                        <div className='flex'>
                            <p className="text-white text-lg py-2 self-end  min-w-1/3">You can reach me at</p>
                        ...
                        <div className='flex'> <p className="text-white text-lg py-2 self-end  min-w-1/3">or Call me at</p>
                        ...
                        <div className='flex'>
                            <p className="text-white text-lg   min-w-1/3 self-end">Also, I would like to add</p>
