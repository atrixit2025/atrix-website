...
//   const { categories, deletePortfolioCategory, fetchCategories ,fetchCategoryCounts, categoryCounts} = useContext(PortfolioCategoryContext);
  ...
  return (
    <>
      <CategoryTable
        ...
        context={PortfolioCategoryContext}
        apiEndpoint="http://localhost:5300/PortfolioCategory"
