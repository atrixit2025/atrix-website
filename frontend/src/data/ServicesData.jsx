...
const ServicesData = [
  ...
  // Branding/Graphic Design-section
  {
    ...
    description_1: "Did You Know Good Design Can Instantly Build Trust With Customers? Graphic design plays a huge role in the digital world. It's not only about things looking pretty; it's about communicating your message effectively and making a great first impression. A good design can make your business stand out, bring in more customers, and build a brand people remember. No matter if it's a logo, website, or social media post, smart design makes your business thrive. ",
    img_1: image_1,
    img_2: image_2,
    sub_service: [
      {
        services_heading: "Create strong visuals of your brand with powerful designs",
        services_desc: "Atrix IT Solutions designers create strong and clear designs that bring your ideas to life and help your business grow. We transform businesses into distinctive brands through strategic design solutions that communicate your unique value and resonate with your target audience across all touchpoints.",
        all_services: [
          {
          ...
          },
          {
            ...
            service_desc: "Branding is all about making your company appear distinctive and professional. It involves making a strong impression that people will remember. We assist you in creating a brand that tells your story, resonates with your audience, and makes a lasting impact on their minds.",
            hover_image: hover_img2
          },
          {
            service_name: "Logo Design",
            service_desc: "A logo represents the face of your company. It should be simple, easy to recognize, and show what you stand for. We design logos that are creative, clear, and perfect for your brand, helping your business stand out from the crowd.",
            hover_image: hover_img3
          },
          {
            service_name: "Packaging",
            service_desc: "Good packaging safeguards your product and grabs the attention of customers. It must be pretty, and tell them what the product is, and get them to want to buy it. We create packaging that is both stunning and smart, allowing you to make a lasting first impression.",
            hover_image: hover_img4
          },
          {
            service_name: " Product Design",
            service_desc: "Product design involves designing products that are fun to use and good-looking. We strive to create products that are not just satisfying to customer needs but also make individuals passionate to use them. Our goal is to mix beauty with function perfectly.",
            hover_image: hover_img
          },

          {
            service_name: "Print Media",
            service_desc: "Print media consists of materials such as brochures, flyers, and posters. Even online, printed materials are effective in reaching individuals. We design clean and eye-catching print materials that clearly share your message and leave a strong impact.",
            hover_image: hover_img2
          },
          {
            service_name: "Advertisement",
            service_desc: "Ads must grab attention immediately and convey your message quickly. We design ads that are bold, concise, and made to get results. Whether for print, social media, or websites, our ads bring more visibility to your business.",
            hover_image: hover_img3
          },
          {
            service_name: "UI/UX",
            service_desc: "UI/UX is short for user interface and user experience. It refers to designing websites and applications that are simple and enjoyable to use. We design layouts that look clean, load fast, and guide users smoothly, helping you keep visitors happy and engaged.",
            hover_image: hover_img4
          },
          {
            service_name: "Social Media Design",
            service_desc: "Good social media designs give your brand a professional look online. We design posts, covers, and ads that suit your style and grab customer attention. Our designs get your brand noticed and build your presence across platforms like Facebook, Instagram, and more.",
            hover_image: hover_img4
          },
